...
export const metadata: Metadata = {
  title: "Assessor AI",
  description: "A inteligência que transforma seu mandato",
  icons: {
    icon: "/favicon.ico",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      ...
      <body className={`${sora.variable} ${noto.variable} font-noto`}>
        <RouteProgressProvider>
          <Toaster richColors position="top-center" />
          <ProjetosReferenciaProvider>{children}</ProjetosReferenciaProvider>
        </RouteProgressProvider>
      </body>
    </html>
  );
