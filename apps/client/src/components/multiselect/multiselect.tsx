...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
      default: "border-foreground/10 bg-gray-100 hover:bg-gray-100 text-foreground shadow-none",
      secondary:
        ...
        <Popover
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md !min-h-10 focus:rounded-md font-normal border h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              ...
              {selectedValues.length > 0 ? (
                <div className="flex justify-between items-center w-full">
                  <div
                        ...
                        return (
                          <Badge
                            ...
                            className={cn(
                              ...
                              multiSelectVariants({ variant, badgeAnimation: animationConfig?.badgeAnimation || "none" }),
                              customStyle?.gradient &&
                            ...
                            <div
                              ...
                              className="ml-1 flex items-center justify-center h-3.5 w-3.5 cursor-pointer hover:bg-white/20 rounded-sm focus:outline-none" >
                              <XIcon className="h-2 w-2 hover:text-gray-700" />
                            </div>
                          </Badge>
                        );
                      })
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        ...
                        <XIcon
                          className={cn(
                            "ml-2 h-4 w-4 cursor-pointer hover:text-gray-700",
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="flex items-center font-normal justify-center h-4 w-4 mx-2 cursor-pointer text-muted-foreground hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-sm">
                    ...
                    />
                    <ChevronDown
                      className="h-4 mx-2 text-muted-foreground/50 cursor-pointer text-muted-foreground"
                      aria-hidden="true"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  ...
                  <ChevronDown className="h-4 text-muted-foreground/50  cursor-pointer text-muted-foreground mr-3" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
          <PopoverContent
            ...
            <Command>
              ...
              <CommandList
                ...
                <CommandEmpty>
                  {emptyIndicator || literals.noResultsFound}
                </CommandEmpty>{" "}
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    <CommandItem
                      ...
                      aria-label={`${literals.selectAll} ${getAllOptions().length
                        } options`}
