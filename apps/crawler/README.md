...
Servico de coleta automatizada de dados legislativos da plataforma AssessorAI. Este app executa spiders para capturar proposicoes, metadados e arquivos publicos de diferentes casas legislativas, servindo como base para pesquisa, organizacao documental e enriquecimento de fluxos internos do produto.
...
- persiste logs, items e downloads em diretórios locais de storage
...
Depois, valide o estado dos servicos:
...
Este app pode funcionar apenas com a infraestrutura de scraping local ou com integracoes adicionais, conforme o uso.
...
As configuracoes padrao do exemplo ja cobrem o uso local basico com Docker.

Tambem e necessario garantir a estrutura de armazenamento local:
...
- nao versione `.env`
- nao versione `storage/`, logs, bases locais ou arquivos baixados
- a publicacao do monorepo remove dados operacionais e artefatos gerados
...
### Acessar a interface operacional
...
### Executar um spider com escopo reduzido

Ao testar spiders localmente, prefira execucoes pequenas. Exemplo:
...
Este app nao possui, hoje, uma suite automatizada padronizada no mesmo nivel dos demais apps. A validacao minima recomendada para desenvolvimento local e:
